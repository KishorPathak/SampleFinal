...
<html>
  <head>
    ...
    <!-- jvectormap
    <link rel="stylesheet" href="${contextPath}/resources/plugins/jvectormap/jquery-jvectormap-1.2.2.css"> -->
    <!-- Date Picker 
  ...
  <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-sm-12">
                         <div class="box box-primary">
                            ...
                            <div class="box-header with-border">
                              <h3 class="box-title">Calories Graph</h3>
                                
                           
                                
                              <div class="piechart-container chart tab-pane" id="calories-chart">
    ...
    <script type="text/javascript" src="${contextPath}/resources/js/employee.js"></script>
	<script>
